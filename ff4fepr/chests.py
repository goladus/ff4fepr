...
other_chest_offsets = dict(
    Life1=[
        0xa8308, # 0x80,0xd4,0xc,0xa,0xfe
        0xa865f, # 0x80,0xd4,0x4,0x10,0xfe
        0xa8664, # 0x80,0xd4,0x12,0xc,0x24
        0xa879a, # 0x80,0xd4,0x5,0x5,0xfe
        0xa8961, # 0x80,0xd4,0x9,0x0,0x60
        0xa89bb, # 0x80,0xd4,0xb,0x5,0xfe
        0xa8dcb, # 0x80,0xd4,0x1a,0x6,0xfe
        0xa8dd0, # 0x80,0xd4,0x11,0x14,0xb7
        0xa91a9, # 0x80,0xd4,0x19,0x15,0xfe
        0xa91e0, # 0x80,0xd4,0x19,0x15,0xfe
        0xa9249, # 0x80,0xd4,0x5,0x9,0xff
        #0xa9352, # 0x80,0xd4,0x19,0x16,0x4b
        #0xa9398, # 0x80,0xd4,0x1d,0x1a,0xfe
        #0xa939d, # 0x80,0xd4,0x17,0x6,0x50
        #0xa9401, # 0x80,0xd4,0x19,0x19,0x54
        #0xa9424, # 0x80,0xd4,0x6,0xd,0x52
        0xa956e, # 0x80,0xd4,0x16,0x15,0x79
        0xaf8d7 # 0x80,0xd4,0x40,0x0,0x0
        ],
    Ether1=[
        0xa8399, # 0x80,0xd1,0xe,0x11,0x10
        0xa842f, # 0x80,0xd1,0x4,0x7,0xfe
        0xa84b1, # 0x80,0xd1,0x16,0x5,0xfe
        0xa85f6, # 0x80,0xd1,0xf,0x3,0xfe
        0xa8650, # 0x80,0xd1,0x4,0xf,0xfe
        0xa86ff, # 0x80,0xd1,0x13,0x1d,0xfe
        0xa8795, # 0x80,0xd1,0x4,0x5,0xfe
        0xa88bc, # 0x80,0xd1,0x8,0x3,0xfe
        0xa88c1, # 0x80,0xd1,0xa,0x3,0xfe
        0xa88f3, # 0x80,0xd1,0x6,0x5,0xfe
        0xa8920, # 0x80,0xd1,0x6,0x6,0xfe
        0xa8975, # 0x80,0xd1,0xb,0x5,0xfe
        0xa89b6, # 0x80,0xd1,0x6,0x3,0xfe
        0xa8a88, # 0x80,0xd1,0x5,0xa,0xfe
        0xa8a8d, # 0x80,0xd1,0x11,0x11,0xfe
        0xa8bd2, # 0x80,0xd1,0x10,0xd,0xfe
        0xa8db2, # 0x80,0xd1,0x1b,0x6,0xfe
        0xa9069, # 0x80,0xd1,0x6,0xb,0xfe
        0xa91a4, # 0x80,0xd1,0x1a,0x6,0xfe
        0xa91f4, # 0x80,0xd1,0x14,0x8,0xfe
        0xa937a, # 0x80,0xd1,0x2,0x6,0xfe
        0xa9384, # 0x80,0xd1,0xe,0xd,0x4d
        0xa93f7 # 0x80,0xd1,0x2,0xe,0x53
        ]
    )
...
def set_chests_for_checking(romdata, arg):
    chest_offsets = other_chest_offsets[arg]
    for index, offset in enumerate(chest_offsets):
        romdata.addmod(offset+1, index+1) # Set the item value (offset+1) to the next item in the list

def revert_chests(romdata, arg):
    chest_offsets = other_chest_offsets[arg]
    for index, offset in enumerate(chest_offsets):
        romdata.addmod(offset+1, items.index(arg))
