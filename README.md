...
Ff4fepr is currently focused on implementing python libraries for modifing the Final Fantasy IV ROM.

works as a command-line tool and is most conveniently installed as a python library. 
